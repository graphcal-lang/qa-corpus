...
3. **Check structure.** Put the project at `projects/<domain>/<project>/`, add `graphcal.toml` and `qa.toml`, declare the exact path in `corpus.toml`, and run `./scripts/validate_corpus.py`.
